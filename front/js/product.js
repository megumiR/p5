...
document.getElementById('addToCart').addEventListener('click',async function(){
    ...
    let colorChosen = await document.getElementById('colors').value; //<option> on ne peux pas recuperer la valeur choisi ...choisir <select>
...
// verifier s'il y a deja des produits du meme id et de la meme couleur 
